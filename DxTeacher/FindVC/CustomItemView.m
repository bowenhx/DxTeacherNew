...
- (HTHorizontalSelectionList *)headView{
    if (!_headView) {
        ...
        _headView.selectionIndicatorAnimationMode = HTHorizontalSelectionIndicatorAnimationModeLightBounce;
//        _headView.selectionIndicatorStyle = HTHorizontalSelectionIndicatorStyleButtonBorder;
        ...
        [_headView setTitleColor:[UIColor colorAppBg] forState:UIControlStateHighlighted];
        [_headView setTitleFont:[UIFont systemFontOfSize:15] forState:UIControlStateNormal];
        [_headView setTitleFont:[UIFont boldSystemFontOfSize:18] forState:UIControlStateSelected];
...
//        if (i == 0) {
//            item.itemLab.textColor = [UIColor colorAppBg];
...
- (void)addItemView:(NSArray *)views title:(NSArray *)titles height:(float)height{
    ...
    [self.itemViews setArray:titles];
    [self.headView reloadData];
